module.exports = {
  ...
  community: process.env.COMMUNITY_NAME || 'for testing workspace',
  // your slack team url (ex: socketio.slack.com)
  slackUrl: process.env.SLACK_URL || 'for-testingworkspace.slack.com',
  ...
  //   --compressed
  slacktoken: process.env.SLACK_TOKEN || 'sf',
